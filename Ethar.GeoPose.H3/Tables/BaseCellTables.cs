// <auto-generated>
// Generated by Ethar.GeoPose.H3.UnitTests/Tools/generate-tables.py from Uber H3 v4.5.0, src/h3lib/lib/baseCells.c. Do not edit by hand.
// </auto-generated>
// <copyright file="BaseCellTables.cs" company="Ethar">
...
{
    /// <summary>
    /// Base cell lookup tables from baseCells.c.
    /// </summary>
    internal static class BaseCellTables
    {
        /// <summary>
        /// Neighboring base cell ID in each IJK direction. 127 indicates there is no neighbor in that direction. C name baseCellNeighbors[NUM_BASE_CELLS][7].
        /// </summary>
        internal static readonly int[,] baseCellNeighbors = new int[,]
        {
        ...
        /// <summary>
        /// Neighboring base cell rotations in each IJK direction. -1 indicates there is no neighbor in that direction. C name baseCellNeighbor60CCWRots[NUM_BASE_CELLS][7].
        /// </summary>
        internal static readonly int[,] baseCellNeighbor60CCWRots = new int[,]
        {
        ...
        /// <summary>
        /// Resolution 0 base cell lookup table for each face, indexed by face, i, j, k. Valid coordinates are 0 to 2. C name faceIjkBaseCells[NUM_ICOSA_FACES][3][3][3].
        /// </summary>
        internal static readonly BaseCellRotation[,,,] faceIjkBaseCells = new BaseCellRotation[,,,]
        {
            {
                // face 0
                {
        ...
        /// <summary>
        /// Resolution 0 base cell data: the home face and ijk+ coordinates on that face, whether the base cell is a pentagon and, for pentagons, the two clockwise offset faces (-1 when none). C name baseCellData[NUM_BASE_CELLS].
        /// </summary>
        internal static readonly BaseCellData[] baseCellData = new BaseCellData[]
        {
            new BaseCellData(new FaceIjk(1, new CoordIjk(1, 0, 0)), false, 0, 0), // base cell 0
            new BaseCellData(new FaceIjk(2, new CoordIjk(1, 1, 0)), false, 0, 0), // base cell 1
            new BaseCellData(new FaceIjk(1, new CoordIjk(0, 0, 0)), false, 0, 0), // base cell 2
            new BaseCellData(new FaceIjk(2, new CoordIjk(1, 0, 0)), false, 0, 0), // base cell 3
            new BaseCellData(new FaceIjk(0, new CoordIjk(2, 0, 0)), true, -1, -1), // base cell 4
            new BaseCellData(new FaceIjk(1, new CoordIjk(1, 1, 0)), false, 0, 0), // base cell 5
            new BaseCellData(new FaceIjk(1, new CoordIjk(0, 0, 1)), false, 0, 0), // base cell 6
            new BaseCellData(new FaceIjk(2, new CoordIjk(0, 0, 0)), false, 0, 0), // base cell 7
            new BaseCellData(new FaceIjk(0, new CoordIjk(1, 0, 0)), false, 0, 0), // base cell 8
            new BaseCellData(new FaceIjk(2, new CoordIjk(0, 1, 0)), false, 0, 0), // base cell 9
            new BaseCellData(new FaceIjk(1, new CoordIjk(0, 1, 0)), false, 0, 0), // base cell 10
            new BaseCellData(new FaceIjk(1, new CoordIjk(0, 1, 1)), false, 0, 0), // base cell 11
            new BaseCellData(new FaceIjk(3, new CoordIjk(1, 0, 0)), false, 0, 0), // base cell 12
            new BaseCellData(new FaceIjk(3, new CoordIjk(1, 1, 0)), false, 0, 0), // base cell 13
            new BaseCellData(new FaceIjk(11, new CoordIjk(2, 0, 0)), true, 2, 6), // base cell 14
            new BaseCellData(new FaceIjk(4, new CoordIjk(1, 0, 0)), false, 0, 0), // base cell 15
            new BaseCellData(new FaceIjk(0, new CoordIjk(0, 0, 0)), false, 0, 0), // base cell 16
            new BaseCellData(new FaceIjk(6, new CoordIjk(0, 1, 0)), false, 0, 0), // base cell 17
            new BaseCellData(new FaceIjk(0, new CoordIjk(0, 0, 1)), false, 0, 0), // base cell 18
            new BaseCellData(new FaceIjk(2, new CoordIjk(0, 1, 1)), false, 0, 0), // base cell 19
            new BaseCellData(new FaceIjk(7, new CoordIjk(0, 0, 1)), false, 0, 0), // base cell 20
            new BaseCellData(new FaceIjk(2, new CoordIjk(0, 0, 1)), false, 0, 0), // base cell 21
            new BaseCellData(new FaceIjk(0, new CoordIjk(1, 1, 0)), false, 0, 0), // base cell 22
            new BaseCellData(new FaceIjk(6, new CoordIjk(0, 0, 1)), false, 0, 0), // base cell 23
            new BaseCellData(new FaceIjk(10, new CoordIjk(2, 0, 0)), true, 1, 5), // base cell 24
            new BaseCellData(new FaceIjk(6, new CoordIjk(0, 0, 0)), false, 0, 0), // base cell 25
            new BaseCellData(new FaceIjk(3, new CoordIjk(0, 0, 0)), false, 0, 0), // base cell 26
            new BaseCellData(new FaceIjk(11, new CoordIjk(1, 0, 0)), false, 0, 0), // base cell 27
            new BaseCellData(new FaceIjk(4, new CoordIjk(1, 1, 0)), false, 0, 0), // base cell 28
            new BaseCellData(new FaceIjk(3, new CoordIjk(0, 1, 0)), false, 0, 0), // base cell 29
            new BaseCellData(new FaceIjk(0, new CoordIjk(0, 1, 1)), false, 0, 0), // base cell 30
            new BaseCellData(new FaceIjk(4, new CoordIjk(0, 0, 0)), false, 0, 0), // base cell 31
            new BaseCellData(new FaceIjk(5, new CoordIjk(0, 1, 0)), false, 0, 0), // base cell 32
            new BaseCellData(new FaceIjk(0, new CoordIjk(0, 1, 0)), false, 0, 0), // base cell 33
            new BaseCellData(new FaceIjk(7, new CoordIjk(0, 1, 0)), false, 0, 0), // base cell 34
            new BaseCellData(new FaceIjk(11, new CoordIjk(1, 1, 0)), false, 0, 0), // base cell 35
            new BaseCellData(new FaceIjk(7, new CoordIjk(0, 0, 0)), false, 0, 0), // base cell 36
            new BaseCellData(new FaceIjk(10, new CoordIjk(1, 0, 0)), false, 0, 0), // base cell 37
            new BaseCellData(new FaceIjk(12, new CoordIjk(2, 0, 0)), true, 3, 7), // base cell 38
            new BaseCellData(new FaceIjk(6, new CoordIjk(1, 0, 1)), false, 0, 0), // base cell 39
            new BaseCellData(new FaceIjk(7, new CoordIjk(1, 0, 1)), false, 0, 0), // base cell 40
            new BaseCellData(new FaceIjk(4, new CoordIjk(0, 0, 1)), false, 0, 0), // base cell 41
            new BaseCellData(new FaceIjk(3, new CoordIjk(0, 0, 1)), false, 0, 0), // base cell 42
            new BaseCellData(new FaceIjk(3, new CoordIjk(0, 1, 1)), false, 0, 0), // base cell 43
            new BaseCellData(new FaceIjk(4, new CoordIjk(0, 1, 0)), false, 0, 0), // base cell 44
            new BaseCellData(new FaceIjk(6, new CoordIjk(1, 0, 0)), false, 0, 0), // base cell 45
            new BaseCellData(new FaceIjk(11, new CoordIjk(0, 0, 0)), false, 0, 0), // base cell 46
            new BaseCellData(new FaceIjk(8, new CoordIjk(0, 0, 1)), false, 0, 0), // base cell 47
            new BaseCellData(new FaceIjk(5, new CoordIjk(0, 0, 1)), false, 0, 0), // base cell 48
            new BaseCellData(new FaceIjk(14, new CoordIjk(2, 0, 0)), true, 0, 9), // base cell 49
            new BaseCellData(new FaceIjk(5, new CoordIjk(0, 0, 0)), false, 0, 0), // base cell 50
            new BaseCellData(new FaceIjk(12, new CoordIjk(1, 0, 0)), false, 0, 0), // base cell 51
            new BaseCellData(new FaceIjk(10, new CoordIjk(1, 1, 0)), false, 0, 0), // base cell 52
            new BaseCellData(new FaceIjk(4, new CoordIjk(0, 1, 1)), false, 0, 0), // base cell 53
            new BaseCellData(new FaceIjk(12, new CoordIjk(1, 1, 0)), false, 0, 0), // base cell 54
            new BaseCellData(new FaceIjk(7, new CoordIjk(1, 0, 0)), false, 0, 0), // base cell 55
            new BaseCellData(new FaceIjk(11, new CoordIjk(0, 1, 0)), false, 0, 0), // base cell 56
            new BaseCellData(new FaceIjk(10, new CoordIjk(0, 0, 0)), false, 0, 0), // base cell 57
            new BaseCellData(new FaceIjk(13, new CoordIjk(2, 0, 0)), true, 4, 8), // base cell 58
            new BaseCellData(new FaceIjk(10, new CoordIjk(0, 0, 1)), false, 0, 0), // base cell 59
            new BaseCellData(new FaceIjk(11, new CoordIjk(0, 0, 1)), false, 0, 0), // base cell 60
            new BaseCellData(new FaceIjk(9, new CoordIjk(0, 1, 0)), false, 0, 0), // base cell 61
            new BaseCellData(new FaceIjk(8, new CoordIjk(0, 1, 0)), false, 0, 0), // base cell 62
            new BaseCellData(new FaceIjk(6, new CoordIjk(2, 0, 0)), true, 11, 15), // base cell 63
            new BaseCellData(new FaceIjk(8, new CoordIjk(0, 0, 0)), false, 0, 0), // base cell 64
            new BaseCellData(new FaceIjk(9, new CoordIjk(0, 0, 1)), false, 0, 0), // base cell 65
            new BaseCellData(new FaceIjk(14, new CoordIjk(1, 0, 0)), false, 0, 0), // base cell 66
            new BaseCellData(new FaceIjk(5, new CoordIjk(1, 0, 1)), false, 0, 0), // base cell 67
            new BaseCellData(new FaceIjk(16, new CoordIjk(0, 1, 1)), false, 0, 0), // base cell 68
            new BaseCellData(new FaceIjk(8, new CoordIjk(1, 0, 1)), false, 0, 0), // base cell 69
            new BaseCellData(new FaceIjk(5, new CoordIjk(1, 0, 0)), false, 0, 0), // base cell 70
            new BaseCellData(new FaceIjk(12, new CoordIjk(0, 0, 0)), false, 0, 0), // base cell 71
            new BaseCellData(new FaceIjk(7, new CoordIjk(2, 0, 0)), true, 12, 16), // base cell 72
            new BaseCellData(new FaceIjk(12, new CoordIjk(0, 1, 0)), false, 0, 0), // base cell 73
            new BaseCellData(new FaceIjk(10, new CoordIjk(0, 1, 0)), false, 0, 0), // base cell 74
            new BaseCellData(new FaceIjk(9, new CoordIjk(0, 0, 0)), false, 0, 0), // base cell 75
            new BaseCellData(new FaceIjk(13, new CoordIjk(1, 0, 0)), false, 0, 0), // base cell 76
            new BaseCellData(new FaceIjk(16, new CoordIjk(0, 0, 1)), false, 0, 0), // base cell 77
            new BaseCellData(new FaceIjk(15, new CoordIjk(0, 1, 1)), false, 0, 0), // base cell 78
            new BaseCellData(new FaceIjk(15, new CoordIjk(0, 1, 0)), false, 0, 0), // base cell 79
            new BaseCellData(new FaceIjk(16, new CoordIjk(0, 1, 0)), false, 0, 0), // base cell 80
            new BaseCellData(new FaceIjk(14, new CoordIjk(1, 1, 0)), false, 0, 0), // base cell 81
            new BaseCellData(new FaceIjk(13, new CoordIjk(1, 1, 0)), false, 0, 0), // base cell 82
            new BaseCellData(new FaceIjk(5, new CoordIjk(2, 0, 0)), true, 10, 19), // base cell 83
            new BaseCellData(new FaceIjk(8, new CoordIjk(1, 0, 0)), false, 0, 0), // base cell 84
            new BaseCellData(new FaceIjk(14, new CoordIjk(0, 0, 0)), false, 0, 0), // base cell 85
            new BaseCellData(new FaceIjk(9, new CoordIjk(1, 0, 1)), false, 0, 0), // base cell 86
            new BaseCellData(new FaceIjk(14, new CoordIjk(0, 0, 1)), false, 0, 0), // base cell 87
            new BaseCellData(new FaceIjk(17, new CoordIjk(0, 0, 1)), false, 0, 0), // base cell 88
            new BaseCellData(new FaceIjk(12, new CoordIjk(0, 0, 1)), false, 0, 0), // base cell 89
            new BaseCellData(new FaceIjk(16, new CoordIjk(0, 0, 0)), false, 0, 0), // base cell 90
            new BaseCellData(new FaceIjk(17, new CoordIjk(0, 1, 1)), false, 0, 0), // base cell 91
            new BaseCellData(new FaceIjk(15, new CoordIjk(0, 0, 1)), false, 0, 0), // base cell 92
            new BaseCellData(new FaceIjk(16, new CoordIjk(1, 0, 1)), false, 0, 0), // base cell 93
            new BaseCellData(new FaceIjk(9, new CoordIjk(1, 0, 0)), false, 0, 0), // base cell 94
            new BaseCellData(new FaceIjk(15, new CoordIjk(0, 0, 0)), false, 0, 0), // base cell 95
            new BaseCellData(new FaceIjk(13, new CoordIjk(0, 0, 0)), false, 0, 0), // base cell 96
            new BaseCellData(new FaceIjk(8, new CoordIjk(2, 0, 0)), true, 13, 17), // base cell 97
            new BaseCellData(new FaceIjk(13, new CoordIjk(0, 1, 0)), false, 0, 0), // base cell 98
            new BaseCellData(new FaceIjk(17, new CoordIjk(1, 0, 1)), false, 0, 0), // base cell 99
            new BaseCellData(new FaceIjk(19, new CoordIjk(0, 1, 0)), false, 0, 0), // base cell 100
            new BaseCellData(new FaceIjk(14, new CoordIjk(0, 1, 0)), false, 0, 0), // base cell 101
            new BaseCellData(new FaceIjk(19, new CoordIjk(0, 1, 1)), false, 0, 0), // base cell 102
            new BaseCellData(new FaceIjk(17, new CoordIjk(0, 1, 0)), false, 0, 0), // base cell 103
            new BaseCellData(new FaceIjk(13, new CoordIjk(0, 0, 1)), false, 0, 0), // base cell 104
            new BaseCellData(new FaceIjk(17, new CoordIjk(0, 0, 0)), false, 0, 0), // base cell 105
            new BaseCellData(new FaceIjk(16, new CoordIjk(1, 0, 0)), false, 0, 0), // base cell 106
            new BaseCellData(new FaceIjk(9, new CoordIjk(2, 0, 0)), true, 14, 18), // base cell 107
            new BaseCellData(new FaceIjk(15, new CoordIjk(1, 0, 1)), false, 0, 0), // base cell 108
            new BaseCellData(new FaceIjk(15, new CoordIjk(1, 0, 0)), false, 0, 0), // base cell 109
            new BaseCellData(new FaceIjk(18, new CoordIjk(0, 1, 1)), false, 0, 0), // base cell 110
            new BaseCellData(new FaceIjk(18, new CoordIjk(0, 0, 1)), false, 0, 0), // base cell 111
            new BaseCellData(new FaceIjk(19, new CoordIjk(0, 0, 1)), false, 0, 0), // base cell 112
            new BaseCellData(new FaceIjk(17, new CoordIjk(1, 0, 0)), false, 0, 0), // base cell 113
            new BaseCellData(new FaceIjk(19, new CoordIjk(0, 0, 0)), false, 0, 0), // base cell 114
            new BaseCellData(new FaceIjk(18, new CoordIjk(0, 1, 0)), false, 0, 0), // base cell 115
            new BaseCellData(new FaceIjk(18, new CoordIjk(1, 0, 1)), false, 0, 0), // base cell 116
            new BaseCellData(new FaceIjk(19, new CoordIjk(2, 0, 0)), true, -1, -1), // base cell 117
            new BaseCellData(new FaceIjk(19, new CoordIjk(1, 0, 0)), false, 0, 0), // base cell 118
            new BaseCellData(new FaceIjk(18, new CoordIjk(0, 0, 0)), false, 0, 0), // base cell 119
            new BaseCellData(new FaceIjk(19, new CoordIjk(1, 0, 1)), false, 0, 0), // base cell 120
            new BaseCellData(new FaceIjk(18, new CoordIjk(1, 0, 0)), false, 0, 0), // base cell 121
        };
    }
}
