...
```text
    ...
    openupm add com.ethar.GeoPose.authority
```
...
There are several patterns available when utilising the GeoPose standard for communicating positional data, ranging from:
